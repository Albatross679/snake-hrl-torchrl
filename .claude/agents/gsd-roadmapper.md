...
Reference full template: `/home/user/snake-hrl-torchrl/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/snake-hrl-torchrl/.claude/get-shit-done/templates/state.md`.
