...
<execution_context>
@/home/user/snake-hrl-torchrl/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/snake-hrl-torchrl/.claude/get-shit-done/workflows/manager.md end-to-end.
