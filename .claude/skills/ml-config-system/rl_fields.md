...
Field specifications for Reinforcement Learning (Level 1c) and PPO (Level 2c). Both inherit all Base fields and built-in infrastructure (output, console, checkpointing, metricslog, mlflow).
