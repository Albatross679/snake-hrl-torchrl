...
from configs import ZhengConfig, WATER, PROPYLENE_GLYCOL, ETHYLENE_GLYCOL
...
def main():
    ...
    if args.sweep == "stiffness":
        run_stiffness_sweep(epochs=args.epochs, device=args.device)
    elif args.sweep == "fluid":
        run_fluid_sweep(epochs=args.epochs, device=args.device)
