...
Usage:
    python -m aprx_model_dismech.preprocess_relative
    python -m aprx_model_dismech.preprocess_relative \
        --input-dir data/surrogate_dismech_rl_step \
        --output-dir data/surrogate_dismech_rl_step_rel128 \
        --workers 8
"""
...
from aprx_model_dismech.state import raw_to_relative
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir", type=str, default="data/surrogate_dismech_rl_step",
        help="Source directory with 124-dim batch_*.pt files",
    )
    parser.add_argument(
        "--output-dir", type=str, default="data/surrogate_dismech_rl_step_rel128",
...
def main():
    ...
    if args.verify and done > 0:
        ...
        from aprx_model_dismech.state import relative_to_raw
