...
Usage:
    python script/evaluate_locomotion.py --task power_velocity --checkpoint checkpoints/final.pt
    python script/evaluate_locomotion.py --task target_tracking --checkpoint checkpoints/final.pt
"""
...
from locomotion.rewards import compute_energy_normalized
...
def evaluate_target_tracking(args):
    ...
    for track_type in track_types:
        ...
        env_config.physics.max_episode_steps = num_steps + 100
        env = PlanarSnakeEnv(config=env_config, device=args.device)
