...
- Company newsletters
- FAQ responses
- Cover letters (industry and academic positions)
...
2. **Load the appropriate guideline file** from the `examples/` directory:
    ...
    - `examples/cover-letters.md` - For cover letters (industry and academic positions)
...
## Keywords
3P updates, company newsletter, company comms, weekly update, faqs, common questions, updates, internal comms, cover letter, cover letters, job application, professional emails, email, academic email, LinkedIn, LinkedIn message, networking, outreach, connection request, DM
