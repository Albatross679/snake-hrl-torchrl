...
def create_gait_shaper(
    ...
    Example:
        ...
        >>> from snake_hrl.demonstrations import DemonstrationBuffer, SerpenoidGenerator
        >>> from snake_hrl.rewards.shaping import create_gait_shaper
        >>>
    ...
    """
    from snake_hrl.rewards.gait_potential import GaitPotential
...
def create_curriculum_gait_shaper(
    ...
    """
    from snake_hrl.rewards.gait_potential import CurriculumGaitPotential
